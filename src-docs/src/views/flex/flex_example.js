...
export const FlexExample = {
  ...
  sections: [{
    ...
    demo: <div className="guideDemo__highlightGrid"><FlexItems /></div>,
  }, {
    ...
    demo: <div className="guideDemo__highlightGrid"><ComponentSpan /></div>,
  }, {
    ...
    demo: <div className="guideDemo__highlightGrid"><FlexGrowZero /></div>,
  }, {
    ...
    demo: <div className="guideDemo__highlightGrid"><FlexGrowNumeric /></div>,
  }, {
    ...
    demo: <div className="guideDemo__highlightGrid"><FlexGutter /></div>,
  }, {
